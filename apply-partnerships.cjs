...
const replacement = fs.readFileSync('partnerships-replacement.txt', 'utf8');

// Normalize line endings for safer matching
const normalizedContent = content.replace(/\r\n/g, '\n');

const startMarker = `            {/* Partnership Requests Tab */}`;

const endMarker = `            {/* Rider Earnings Tab */}`;
...
console.log("Successfully replaced Partnerships Tab via Node script!");
