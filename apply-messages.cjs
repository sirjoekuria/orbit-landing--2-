...
const replacement = fs.readFileSync('messages-replacement.txt', 'utf8');

// Normalize line endings for safer matching
const normalizedContent = content.replace(/\r\n/g, '\n');

const startMarker = `            {/* Messages Tab */}`;

const endMarker = `            {/* Users Tab */}`;
...
console.log("Successfully replaced Messages Tab via Node script!");
