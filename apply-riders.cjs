...
const replacement = fs.readFileSync('riders-replacement.txt', 'utf8');

// Normalize line endings for safer matching
const normalizedContent = content.replace(/\r\n/g, '\n');

const startMarker = `            {/* Riders Tab */}`;

const endMarker = `            {/* Partnership Requests Tab */}`;
...
console.log("Successfully replaced Riders Tab via Node script!");
