...
// Make sure to preserve original endings if needed, but it's simpler to just write back LF.
// Prettier will reformat it anyway if it is set up. We'll write it back with LF since Node fs can handle cross-platform fine.
