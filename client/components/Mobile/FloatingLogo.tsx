        ...
        <AnimatePresence>
            ...
            >
                <div className="relative group">
                    ...
                    <div className="relative w-14 h-14 bg-card/10 backdrop-blur-md rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(234,179,8,0.3)] border border-border/20 transition-transform active:scale-95 overflow-hidden">
