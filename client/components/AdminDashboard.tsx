...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'read': return 'bg-gray-100 text-foreground';
            ...
            <div className="flex items-center space-x-3">
              <label className="flex items-center space-x-2 text-sm">
                ...
                <input
                  ...
                  className="toggle-checkbox w-10 h-6 appearance-none bg-gray-200 rounded-full relative cursor-pointer transition-colors before:content-[''] before:absolute before:w-4 before:h-4 before:bg-card before:rounded-full before:top-1 before:left-1 checked:bg-rocs-green"
                />
              </label>
                ...
                <div className="space-y-4">
                  {messages.length === 0 ? (
                    ...
                    messages.map((message) => (
                      <div
                        key={message.id}
                        className="border rounded-lg p-4 hover:bg-background transition-colors"
                      >
                        ...
                        <p className="text-muted-foreground text-sm mb-3">{message.message}</p>
                      ...
                      >
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">{formatDate(order.timestamp)}</p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">{order.delivery}</p>
                          </div>
                        </div>

                        <div className="flex justify-between items-center">
                          <div className="text-sm">
                            <span className="text-muted-foreground">Distance: {order.distance}km</span>
